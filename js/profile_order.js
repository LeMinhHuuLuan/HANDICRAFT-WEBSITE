...
function viewOrder(id) {
    ...
    .then(data => {
        if (data.success) {
            ...
            document.getElementById('orderCustomer').textContent = (order.full_name || 'Không xác định') + ' (' + (order.email || 'Không xác định') + ')';
            ...
            document.getElementById('orderStatus').textContent = order.status || 'Đang chờ xử lý';
